...
public class CkXml {
  ...
  public CkXml(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(CkXml obj) {
  ...
  public CkXml GetSelf() {
    ...
    return (cPtr == 0) ? null : new CkXml(cPtr, false);
  }
  ...
  public String attr(String name) {
    return chilkatJNI.CkXml_attr(swigCPtr, this, name);
  }

  public String attrValue(int index) {
    return chilkatJNI.CkXml_attrValue(swigCPtr, this, index);
  }

  public String attrName(int index) {
    return chilkatJNI.CkXml_attrName(swigCPtr, this, index);
  }
  ...
  public boolean SetBinaryContent(CkByteData bData, boolean zipFlag, boolean encryptFlag, String password) {
    return chilkatJNI.CkXml_SetBinaryContent(swigCPtr, this, CkByteData.getCPtr(bData), bData, zipFlag, encryptFlag, password);
  }
  ...
  public boolean Clear() {
    return chilkatJNI.CkXml_Clear(swigCPtr, this);
  }
  ...
  public CkXml SearchForAttribute(CkXml after, String tag, String attr, String valuePattern) {
    long cPtr = chilkatJNI.CkXml_SearchForAttribute(swigCPtr, this, CkXml.getCPtr(after), after, tag, attr, valuePattern);
    return (cPtr == 0) ? null : new CkXml(cPtr, true);
  }

  public CkXml SearchAllForContent(CkXml after, String contentPattern) {
    long cPtr = chilkatJNI.CkXml_SearchAllForContent(swigCPtr, this, CkXml.getCPtr(after), after, contentPattern);
    return (cPtr == 0) ? null : new CkXml(cPtr, true);
  }

  public CkXml SearchForContent(CkXml after, String tag, String contentPattern) {
    long cPtr = chilkatJNI.CkXml_SearchForContent(swigCPtr, this, CkXml.getCPtr(after), after, tag, contentPattern);
    return (cPtr == 0) ? null : new CkXml(cPtr, true);
  }

  public CkXml SearchForTag(CkXml after, String tag) {
    long cPtr = chilkatJNI.CkXml_SearchForTag(swigCPtr, this, CkXml.getCPtr(after), after, tag);
    return (cPtr == 0) ? null : new CkXml(cPtr, true);
  }

  public boolean SearchForAttribute2(CkXml after, String tag, String attr, String valuePattern) {
    return chilkatJNI.CkXml_SearchForAttribute2(swigCPtr, this, CkXml.getCPtr(after), after, tag, attr, valuePattern);
  }

  public boolean SearchAllForContent2(CkXml after, String contentPattern) {
    return chilkatJNI.CkXml_SearchAllForContent2(swigCPtr, this, CkXml.getCPtr(after), after, contentPattern);
  }

  public boolean SearchForContent2(CkXml after, String tag, String contentPattern) {
    return chilkatJNI.CkXml_SearchForContent2(swigCPtr, this, CkXml.getCPtr(after), after, tag, contentPattern);
  }

  public boolean SearchForTag2(CkXml after, String tag) {
    return chilkatJNI.CkXml_SearchForTag2(swigCPtr, this, CkXml.getCPtr(after), after, tag);
  }
  ...
  public boolean GetAttrValue(String name, CkString str) {
    return chilkatJNI.CkXml_GetAttrValue(swigCPtr, this, name, CkString.getCPtr(str), str);
  }

  public boolean GetAttributeValue(int index, CkString str) {
    return chilkatJNI.CkXml_GetAttributeValue(swigCPtr, this, index, CkString.getCPtr(str), str);
  }

  public boolean GetAttributeName(int index, CkString str) {
    return chilkatJNI.CkXml_GetAttributeName(swigCPtr, this, index, CkString.getCPtr(str), str);
  }
  ...
  public boolean GetXml(CkString str) {
    return chilkatJNI.CkXml_GetXml(swigCPtr, this, CkString.getCPtr(str), str);
  }
  ...
  public boolean put_Cdata(boolean newVal) {
    return chilkatJNI.CkXml_put_Cdata(swigCPtr, this, newVal);
  }
  ...
  public boolean GetChildContent(String tag, CkString str) {
    return chilkatJNI.CkXml_GetChildContent(swigCPtr, this, tag, CkString.getCPtr(str), str);
  }
  ...
  public boolean SaveLastError(String filename) {
    return chilkatJNI.CkXml_SaveLastError(swigCPtr, this, filename);
  }
  ...
  public boolean QEncodeContent(String charset, CkByteData db) {
    return chilkatJNI.CkXml_QEncodeContent(swigCPtr, this, charset, CkByteData.getCPtr(db), db);
  }

  public boolean BEncodeContent(String charset, CkByteData db) {
    return chilkatJNI.CkXml_BEncodeContent(swigCPtr, this, charset, CkByteData.getCPtr(db), db);
  }

  public boolean DecodeContent(CkByteData db) {
    return chilkatJNI.CkXml_DecodeContent(swigCPtr, this, CkByteData.getCPtr(db), db);
  }
  ...
  public boolean GetChildIntValue(String tag, SWIGTYPE_p_int value) {
    return chilkatJNI.CkXml_GetChildIntValue(swigCPtr, this, tag, SWIGTYPE_p_int.getCPtr(value));
  }
  ...
  public void AccumulateTagContent(String tag, String skipTags, CkString str) {
    chilkatJNI.CkXml_AccumulateTagContent(swigCPtr, this, tag, skipTags, CkString.getCPtr(str), str);
  }

  public boolean GetChildContentByIndex(int index, CkString str) {
    return chilkatJNI.CkXml_GetChildContentByIndex(swigCPtr, this, index, CkString.getCPtr(str), str);
  }

  public boolean GetChildTag(int index, CkString str) {
    return chilkatJNI.CkXml_GetChildTag(swigCPtr, this, index, CkString.getCPtr(str), str);
  }
