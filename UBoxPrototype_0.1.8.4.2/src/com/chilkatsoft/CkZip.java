...
public class CkZip {
  ...
  public CkZip(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(CkZip obj) {
  ...
  public String proxy() {
    return chilkatJNI.CkZip_proxy(swigCPtr, this);
  }
  ...
  public void get_Version(CkString pVal) {
    chilkatJNI.CkZip_get_Version(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }

  public void get_TempDir(CkString pVal) {
    chilkatJNI.CkZip_get_TempDir(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }
  ...
  public void get_AppendFromDir(CkString pVal) {
    chilkatJNI.CkZip_get_AppendFromDir(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }
  ...
  public void get_Proxy(CkString pVal) {
    chilkatJNI.CkZip_get_Proxy(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }

  public void put_Proxy(String newVal) {
    chilkatJNI.CkZip_put_Proxy(swigCPtr, this, newVal);
  }

  public void get_DecryptPassword(CkString pVal) {
    chilkatJNI.CkZip_get_DecryptPassword(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }
  ...
  public void get_EncryptPassword(CkString pVal) {
    chilkatJNI.CkZip_get_EncryptPassword(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }
  ...
  public void get_FileName(CkString pVal) {
    chilkatJNI.CkZip_get_FileName(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }
  ...
  public void get_Comment(CkString pVal) {
    chilkatJNI.CkZip_get_Comment(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }
  ...
  public void get_PathPrefix(CkString pVal) {
    chilkatJNI.CkZip_get_PathPrefix(swigCPtr, this, CkString.getCPtr(pVal), pVal);
  }
  ...
  public void GetDirectoryAsXML(CkString xml) {
    chilkatJNI.CkZip_GetDirectoryAsXML(swigCPtr, this, CkString.getCPtr(xml), xml);
  }
  ...
  public boolean OpenFromWeb(String url) {
    return chilkatJNI.CkZip_OpenFromWeb(swigCPtr, this, url);
  }
  ...
  public boolean AppendOneFileOrDir(String fileOrDirName) {
    return chilkatJNI.CkZip_AppendOneFileOrDir__SWIG_0(swigCPtr, this, fileOrDirName);
  }

  public boolean AppendOneFileOrDir(String fileOrDirName, boolean saveExtraPath) {
    return chilkatJNI.CkZip_AppendOneFileOrDir__SWIG_1(swigCPtr, this, fileOrDirName, saveExtraPath);
  }
  ...
  public CkZipEntry AppendData(String fileName, CkByteData data) {
    long cPtr = chilkatJNI.CkZip_AppendData(swigCPtr, this, fileName, CkByteData.getCPtr(data), data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }
  ...
  public CkZipEntry AppendNewDir(String dirName) {
    ...
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, false);
  }
  ...
  public CkZipEntry AppendCompressed(String fileName, CkByteData data) {
    long cPtr = chilkatJNI.CkZip_AppendCompressed(swigCPtr, this, fileName, CkByteData.getCPtr(data), data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }
  ...
  public CkZipEntry AppendBase64(String fileName, String data) {
    long cPtr = chilkatJNI.CkZip_AppendBase64(swigCPtr, this, fileName, data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public CkZipEntry AppendHex(String fileName, String data) {
    long cPtr = chilkatJNI.CkZip_AppendHex(swigCPtr, this, fileName, data);
    return (cPtr == 0) ? null : new CkZipEntry(cPtr, true);
  }

  public boolean WriteToMemory(CkByteData bData) {
    return chilkatJNI.CkZip_WriteToMemory(swigCPtr, this, CkByteData.getCPtr(bData), bData);
  }
  ...
  public boolean SaveLastError(String filename) {
    return chilkatJNI.CkZip_SaveLastError(swigCPtr, this, filename);
  }
